...
exports.solveRecaptchaV2 = solveRecaptchaV2;
exports.extractRecaptchaSiteKey = extractRecaptchaSiteKey;
exports.solvePageRecaptcha = solvePageRecaptcha;
...
const solver = new _2captcha_1.Solver(TWOCAPTCHA_API_KEY);
/**
 ...
 */
async function solveRecaptchaV2(page, siteKey, pageUrl) {
    ...
    await page.evaluate((token) => {
        ...
        iframes.forEach((iframe) => {
            try {
                ...
                const iframeResponseField = iframeDoc?.querySelector('#g-recaptcha-response');
 ...
 */
async function solvePageRecaptcha(page, manualSiteKey) {
